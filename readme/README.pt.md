...
Dentro: uma fila de trabalho ordenada por gravidade real, um registro de decisões que anota *o que me faria mudar de ideia*, e **um livro de erros com 42 lições, cada uma paga com um engano real**. Essa última parte é a valiosa: a estrutura se reconstrói numa tarde; as cicatrizes não.
