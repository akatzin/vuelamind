...
Un vault de texto plano y un ciclo de tres actos: **nacer** una vez, **retomarse** al abrir cada sesión —midiendo el estado actual en vez de confiar en lo que se recuerda— y **reconciliarse** al cerrarla.
