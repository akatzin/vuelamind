...
> forma de dato.
9. **Releer lo que la sesión escribió, antes de dar el cierre por bueno.** Ni el barrido del radio ni el validador lo hacen: el primero mira las **vecinas** de lo tocado, el segundo mira **mecánica** —conteos, enlaces, huellas—. **Un párrafo nuevo que afirma algo falso pasa los dos**, porque cuadra, enlaza y no contradice a nadie. Lo que hace falta es un **diff de la sesión**: una copia de las notas tomada al abrir y comparada al cerrar. **No hace falta git** — y meterlo sube la barrera para quien no es técnico sin dar nada que este diff no dé, porque lo que se necesita es una sesión, no una historia. La herramienta del canon es `herramientas/instantanea_vault.sh`, y el dominio la engancha en `antes_de_medir` para que nadie tenga que acordarse. Si la instantánea falta, **se dice** en vez de seguir como si se hubiera releído.
